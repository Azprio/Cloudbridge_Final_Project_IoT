...
<html lang="en">
	...
	<!-- <meta http-equiv="refresh" content="5">  --!>
        <title>Cloud Bridge Admin Panel</title>
        ...
        <div class="container-fluid-full">
            <div class="row-fluid">
                ...
                <div id="content" class="span10">
                    ...
                    if (isset($pages)) {
                        if ($pages == 'room_a') {
                            include './pages/manage_room_a.php';
                        }else if($pages=='edit_room_a'){
                            include './pages/edit_room_a_content.php';
                        }else if($pages=='room_b'){
                            include './pages/manage_room_b.php';
                        }else if($pages=='edit_room_b'){
                            include './pages/edit_room_b_content.php';
